...
;; URL: https://codeberg.org/jcastp/org-tracktable
;; Created: 2015-11-03
;; Keywords: org, writing
;; Package-Requires: ((emacs "24")(cl-lib "0.5")(org-context-extended "0.1"))
;; Version: 0.1
...
;; This is a personal fork from tty-tourist's org-tracktable:
;; URL: https://github.com/tty-tourist/org-tracktable
;; The main changes involve using an external library, called org-context-extended,
;; with some custom helper functions and a custom org mode word counter
;; functions. The objective is to count just prose words, ignoring org mode
;; words related to its features, such as drawers, comments, blocks, etc.

;; The org-tracktable package provides these three interactive functions:
...
;; This package uses `org-context-count-words' from org-context-extended.el
;; (https://codeberg.org/jcastp/org-context-extended) for word
...
(require 'cl-lib)
(require 'org-table)
;; located at https://codeberg.org/jcastp/org-context-extended
(require 'org-context-extended)
