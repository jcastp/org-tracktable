...
This is my personal fork of the org-tracktable repository by tty-tourist, located here: https://github.com/tty-tourist/org-tracktable
The main changes are:
- Requires =org-context-extended=, located at: https://codeberg.org/jcastp/org-context-extended
  This custom library contains function to count words in org files, =org-context-count-words=, configurable to ignore:
    - org comment lines
    - org drawers
    - org headings
    - org properties
    - org blocks: code, quote, etc
    - org tables
    - ignore the text in headings with particular tags, that can be defined by the user
  - =org-tracktable.el=
    - Removed all the helper functions for ignoring org features, as they are now in the =org-context-extended.el= file.
    - The word counting function is also located in =org-context-extended.el=.
...
=org-tracktable= is inspired by [[https://github.com/dato/org-wc/blob/master/org-wc.el][org-wc.el]], [[https://github.com/noctuid/chronicler][chronicler.el]], and [tty-tourist's org-tracktable](https://github.com/tty-tourist/org-tracktable).
