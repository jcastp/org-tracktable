...
This is my personal fork of the org-tracktable repository.
The main changes are:
- Separated the logic into two files:
  - =org-context-extended.el=
    - Contains function to count words in org files, =org-context-count-words=, configurable to ignore:
      - org comment lines
      - org drawers
      - org headings
      - org properties
